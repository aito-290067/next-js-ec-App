    ...
    <>
      <div className="container flex flex-wrap justify-center items-center mx-auto py-5 px-5 bg-white-100 my-12">
        ...
        <form className="bg-gray-50 p-4 rounded-xl">
          <NameInput
            lastNameValue={props.lastNameValue} SetLastNameValue={props.SetLastNameValue}
            firstNameValue={props.firstNameValue}
            SetFirstNameValue={props.SetFirstNameValue}

            firstNameErrorState={props.firstNameErrorState} SetFirstNameErrorState={props.SetFirstNameErrorState}
          ...
          <TelInput
            telValue={props.telValue} SetTelValue={props.SetTelValue} telErrorState={props.telErrorState} SetTelErrorState={props.SetTelErrorState}
            errorFlag={props.errorFlag}
          ...
          <ZipInput
            zipValue={props.zipValue} SetZipValue={props.SetZipValue} zipErrorState={props.zipErrorState} SetZipErrorState={props.SetZipErrorState}
            errorFlag={props.errorFlag}
          ...
          <AddressInput
            ...
            SetAddressValue={props.SetAddressValue} addressErrorState={props.addressErrorState} SetAddressErrorState={props.SetAddressErrorState}
            errorFlag={props.errorFlag}
          ...
          <div className="items-center justify-center flex flex-wrap my-4 ">
            ...
            <button type="button" className="text-white px-6 py-3 rounded-md text-sm mr-3 mt-5 w-96 bg-[#75ad9d] shadow-md focus:shadow-none focus:opacity-70"
              onClick={() => {
                if (
                  ...
                  props.SetOrdererName(`${props.ordererLastName} ${props.ordererFirstName}`)
