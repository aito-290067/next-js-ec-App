...
export const Header = () => {
  // const [hamburgerMenuDisplayState, HamburgerMenuDisplayState] = React.useState("none")

  return (
    <>
      {/* <nav className="px-2 border-gray-200 dark:bg-gray-900 dark:border-gray-700 bg-gray-100"> */}
      <div className="container flex flex-wrap justify-between items-center mx-auto py-5 px-5  bg-gray-50 opacity-0.1">
        <Logo path="/logo.png" />

        <ul className="float-right ">
          <HeaderListGoogleIcon name="person" path={`/users/login`} />
          <HeaderListGoogleIcon name="shopping_cart" path={`/carts`} />
          <HeaderListGoogleIcon name="favorite" path={`/carts/confirm`} />
          {/* <HeaderListText name="register" path={`/users/`}/>
          <HeaderListText name="top" path={`/`}/>
          <HeaderListText name="items" path={`/items`}/> */}
          {/* <HeaderListGoogleIcon name="menu" path={`/items`} /> */}
          {/* <button onClick={() => {

            }}>
              <div>
                <hr className={`bg-black  w-6 h-1 mb-0.5 ${style.routeTop}`} />
                <hr className="bg-black  w-6 h-1 mb-0.5" style={{ display: `${hamburgerMenuDisplayState}` }} />
                <hr className={`bg-black  w-6 h-1 mb-0.5 ${style.routeBottom}`} />
              </div>
            </button> */}
        </ul>
      </div>
...
//             <Image
//               src="/logo.png"
//               className="mr-3 h-6 sm:h-10" alt="Flowbite Logo"
//               width={50}
//               height={50} />
...
//                 {/* <!-- Dropdown menu --> */}
//                 <div id="dropdownNavbar" className="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="bottom" style={{ position: "absolute", inset: "0px auto auto 0px", margin: "0px", transform: "translate(0px, 10px)", }}>
